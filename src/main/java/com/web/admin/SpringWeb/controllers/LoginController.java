...
public class LoginController {
    ...
    // O "HttpServletResponse response" é para criar um cookie para proteger a rota do login. Para usar o cookie, nós criamos a pasta "Servico" com a classe "CookieService.java"
        ...
        if( adm != null ) { // se o Login deu certo, fazemos um redirect
            ...
            if(lembrar != null) tempoLogado = (60*60*24*365); // Se usuário marcou caixa "Lembrar" na tela do Login, fazemos 1 ano de cookie
            CookieService.setCookie(response, "usuariosId", String.valueOf(adm.getId()), tempoLogado); // o "usuariosId" vai ser o nome do cookie que vamos gravar
